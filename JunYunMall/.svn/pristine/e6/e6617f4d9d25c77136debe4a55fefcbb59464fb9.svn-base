package cn.junyun.mall.activity.myachievement;
 ...
 * @date 2016年8月17日
 */
@ContentView(R.layout.activity_my_achievement)
public class MyAchievementActivity extends BaseActivity {
	...
	protected void fillView() {
		...
		super.fillView();
		mBackTv.setText(getResources().getString(R.string.str_tv_mymall_myachievement));//设置成我的成就标题
