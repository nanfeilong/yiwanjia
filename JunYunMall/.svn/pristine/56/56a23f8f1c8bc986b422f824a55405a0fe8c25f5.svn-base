...
public class CityAddressSelectActivity extends BaseActivity {
	...
	protected void setListener() {
		mProviceLv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				startActivity(new Intent(CityAddressSelectActivity.this,AreaAddressSelectActivity.class));
	...
	private void testData() {
		mAddressEntities.add(new AddressEntity("西安市"));
		mAddressEntities.add(new AddressEntity("咸阳市"));
